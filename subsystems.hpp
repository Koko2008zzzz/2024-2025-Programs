...
inline pros::Optical colorSorter(15);
inline pros::Rotation intakeRotation(4);
...
inline int states[numStates] = {0, 4900, 17025, 19500, 23000, 25000}; // states for Lady Brown 49, 170.25, 195, 230, 250 degrees
...
inline double kP =0.25; // proportional constant for Lady Brown
inline double kD =0.05; // derivative constant for Lady Brown
